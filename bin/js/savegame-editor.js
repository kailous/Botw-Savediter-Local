...
// 	}, false);
	...
	var savedatalist = document.createElement('div');
	savedatalist.id = 'savedata';
	savedatalist.innerHTML = '<div id="config"><p>用户ID：</p><input type="userID" value="80000002" id="userID"><select type="renionID" id="renionID"><option value="9300">日版</option><option value="9400">美版</option><option value="9500">欧版</option></select><button onclick="myFunction()">找到我的存档</button></div><div class="box"><ul id="savedata-list"></ul></div>'
	document.body.appendChild(savedatalist);
	document.body.appendChild(dragZone);
	// test 到这里结束
